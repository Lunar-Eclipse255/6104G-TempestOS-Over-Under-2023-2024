...
// Ticks per inch
#define TPI 35        // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 35 // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH                                                            \
	13 // The distance between left and right wheels (or tracker wheels)
